...
protected void onCreate(Bundle savedInstanceState) {
...

    {
        public void onClick(View v) {
            ...
            sendMessage.putExtra("NAME", message);
            startActivity(sendMessage);
Intent sendMessage = new Intent(MainActivity.this,     DisplayMessageActivity.class);
            sendMessage.putExtra("AGE", message);
            startActivity(sendMessage);
Intent sendMessage = new Intent(MainActivity.this,     DisplayMessageActivity.class);
            sendMessage.putExtra("BIO", message);
            startActivity(sendMessage);
Intent sendMessage = new Intent(MainActivity.this,     DisplayMessageActivity.class);
            sendMessage.putExtra("MOBILE NUMBER", message);
            startActivity(sendMessage);
Intent sendMessage = new Intent(MainActivity.this,     DisplayMessageActivity.class);
            sendMessage.putExtra("LOCATION", message);
            startActivity(sendMessage);
